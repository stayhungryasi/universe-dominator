...
/* ud-hdr-refine-v3 — 네이비 계기판 헤더: 아이보리 본문 위 관측 장비 띠 */
.site-header { background: #1C2333; border-bottom: none; position: relative; }
[data-theme="dark"] .site-header { background: #10141F; }
.site-header::after {
  content: ''; position: absolute; left: 0; right: 0; bottom: 0; height: 2px;
  background: linear-gradient(90deg, transparent, rgba(212,166,88,0.7) 28%, rgba(212,166,88,0.7) 72%, transparent);
}
.site-header .ud-logo, .site-header .ud-logo-word { color: #F5EFDF; }
.site-header .ud-logo-mark { --gold: #D4A658; }
.site-header .ud-logo-word .v { color: #D4A658; }
.site-header .ud-logo-word { letter-spacing: 0.24em; }
.site-header .header-right {
  background: rgba(250,246,236,0.06); border-color: rgba(250,246,236,0.16);
  box-shadow: none;
}
.site-header .update-badge { color: #B5BFD6; }
.site-header .update-badge .ud-date { color: #B5BFD6; }
.site-header .update-badge .ud-clock { color: #E9C87E; }
.site-header .update-badge::before { background: #D4A658; box-shadow: 0 0 8px rgba(212,166,88,0.8); }
.site-header .rate-badge { color: #8590AA; border-left-color: rgba(250,246,236,0.14); }
.site-header .rate-badge #usdKrwDisplay { color: #F5EFDF; }
.site-header .rate-badge:hover #usdKrwDisplay, .site-header .rate-badge:hover .rate-badge-arrow { color: #E9C87E; }
.site-header .theme-toggle { color: #B5BFD6; border-left-color: rgba(250,246,236,0.14); }
.site-header .theme-toggle:hover { color: #E9C87E; }
</style>
<script>
...
def inject_header_fix():
    ...
    for name in pages:
        ...
        if not f.exists():
            continue
        html = f.read_text(encoding="utf-8")
        if "ud-hdr-refine-v3" in html or "</head>" not in html:
            continue
